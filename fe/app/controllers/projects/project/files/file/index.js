...
export default Ember.Controller.extend({
      ...
      xAxis: {
        ...
        labels: {
          formatter: function () {
            ...
            var url = target.generate('projects.project.files.file.reports.report', id, this.value);
          ...
          point: {
            events: {
              click: function () {
                ...
                location.href = target.generate('projects.project.files.file.reports.report', id, this.category);
              }
            }
          }
        }
  ...
  chartData: computed('model.reports.[]', function () {
    const reports = this.get('model.reports');
